...
import { ProductsDummyData } from '../const/ProductsDummyData'
import { ProductType } from '../const/DataTypes'

const ProductList: React.FC = () => {
    const navigation = useNavigation()
    const [product_list, setProductList] =
        useState<ProductType[]>(ProductsDummyData)
